...
import net.minecraft.world.level.block.entity.BlockEntity;import net.minecraft.core.BlockPos;
...
public final class AdvancedEnergyTransmitterAE2Integration
    ...
    /** Forge 1.20.1 exposes the AE2 grid node through AttachCapabilitiesEvent. */
    public static void attachCapability(AttachCapabilitiesEvent<BlockEntity> event) {
        if (!(event.getObject() instanceof AdvancedEnergyTransmitterBE transmitter)) {
            return;
        }
        event.addCapability(
                com.jdte.JDTE.id("ae2_grid_node"),
                new ICapabilityProvider() {
                    ...
                    public <T> LazyOptional<T> getCapability(net.minecraftforge.common.capabilities.Capability<T> capability,
                        ...
                        return LazyOptional.of(() -> (T) (Object)
                                transmitter.getEnergyNetworkSource().getGridNodeHost());
                    }
                });
    }

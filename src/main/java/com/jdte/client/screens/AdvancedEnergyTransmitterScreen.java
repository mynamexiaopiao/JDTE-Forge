...
public class AdvancedEnergyTransmitterScreen extends BaseMachineScreen<AdvancedEnergyTransmitterContainer> {
    private static final ResourceLocation BIND_PLAYER_ICON = new ResourceLocation(
        ...
        boundPlayerButton = new GrayscaleButton(
                ...
                boundButtonState, button -> {
                    if (baseMachineBE instanceof AdvancedEnergyTransmitterBE transmitter) {
                        JDTEPacketHandler.CHANNEL.sendToServer(new AdvancedEnergyTransmitterBindingPayload(
    ...
    public void saveSettings() {
        super.saveSettings();
        if (baseMachineBE instanceof AdvancedEnergyTransmitterBE transmitter) {
            JDTEPacketHandler.CHANNEL.sendToServer(new AdvancedEnergyTransmitterPayload(
